...
int main(int argc, char** argv) {
    ...
    cout<<setw(3)<<2<<setw(13)<<w2<<setw(13)<<l2<<endl;
    cout<<setw(3)<<3<<setw(13)<<w3<<setw(13)<<l3<<endl;
    cout<<setw(3)<<4<<setw(13)<<w4<<setw(13)<<l4<<endl;
    cout<<setw(3)<<5<<setw(13)<<w5<<setw(13)<<l5<<endl;
    cout<<setw(3)<<6<<setw(13)<<w6<<setw(13)<<l6<<endl;
    cout<<setw(3)<<7<<setw(13)<<w7<<setw(13)<<l7<<endl;
    cout<<setw(3)<<8<<setw(13)<<w8<<setw(13)<<l8<<endl;
    cout<<setw(3)<<9<<setw(13)<<w9<<setw(13)<<l9<<endl;
    cout<<setw(3)<<10<<setw(13)<<w10<<setw(13)<<l10<<endl;
    cout<<setw(3)<<11<<setw(13)<<w11<<setw(13)<<l11<<endl;
    cout<<setw(3)<<12<<setw(13)<<w12<<setw(13)<<l12<<endl;
